...
const sections = [
  {
    ...
    content: (
      <Paragraph>
        ...
        for the functioning of Anifusion, such as account information and user
        preferences.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <strong>Cookies and Tracking</strong>: Anifusion uses cookies and similar
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        <strong>Acceptance of Terms</strong>: By using Anifusion, you agree to
        these Terms of Service and acknowledge that they affect your legal
        rights and obligations.
        <br></br>
        <br></br>
        <strong>Content</strong>: Anifusion does not host video content but embeds
        ...
        of the embedded videos remain with their respective owners. Anifusion
