...
const sections = [
  {
    title: 'About',
    title2: "What's Anifusion?",
    content: (
      <Paragraph>
        Anifusion is an anime streaming site where you can watch anime online in HD
    ...
    content: (
      <>
        ...
        <Paragraph>
          ...
          Anifusion works seamlessly on both{' '}
