...
const sections = [
  {
    title: 'About',
    title2: "What's Scrive.in?",
    content: (
      <Paragraph>
        Scrive.in is an anime streaming site where you can watch anime online in HD
    ...
    content: (
      <>
        ...
        <Paragraph>
          ...
          Scrive.in works seamlessly on both{' '}
